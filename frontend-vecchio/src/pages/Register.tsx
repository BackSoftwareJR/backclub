        ...
        try {
            ...
            if (err.response?.data?.errors) {
                ...
                if (typeof errorData === 'string' && errorData.includes('PHP version')) {
                    setError('Server error: PHP version not compatible. Please contact the administrator.');
                } else if (typeof errorData === 'string' && errorData.includes('Composer')) {
                    setError('Server error: dependency issue. Please contact the administrator.');
                } else {
        ...
        <div className="min-h-screen bg-slate-950 flex items-center justify-center p-4 relative overflow-hidden">
            ...
            <div className="glass-card w-full max-w-md p-8 rounded-2xl relative z-10">
                <div className="flex flex-col items-center mb-8">
                    ...
                    <p className="text-slate-400">Join Back Club today</p>
                </div>
