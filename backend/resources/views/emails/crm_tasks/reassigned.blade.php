...
@section('content')
    <h1>Task Riassegnato</h1>
    <p>Ciao {{ $assigneeName }},</p>
    <p>Il task <strong>{{ $task->title }}</strong> ti è stato riassegnato da {{ $assignedByName }}.</p>
    ...
    <p style="text-align: center; margin-top: 30px;">
        <a href="{{ config('app.url') }}/freelance/progetti/{{ $project->id ?? $task->crm_project_id }}/gestione?tab=tasks" class="btn-primary">Vedi Task</a>
    </p>
