...
const PreventiviPage: React.FC = () => {
  ...
  return (
    <div className="segreteria-preventivi-page">
                ...
                {filteredQuotes.map((quote) => {
                  ...
                  return (
                    <tr key={quote.id}>
                      ...
                      <td className="total-cell">€ {quote.total_amount?.toLocaleString('it-IT', { minimumFractionDigits: 2 }) || '0.00'}</td>
                      <td>
                      ...
                      <td>
                        <div className="action-buttons">
                          <button
                            className="btn-icon"
                            onClick={() => navigate(`/segreteria/preventivi/${quote.id}`)}
                            title="Visualizza"
                          >
                            <Eye size={16} />
                          </button>
